...
const doNotDelete = "[ ☆ | ♥ 𝔻𝕒𝕧𝕚𝕕 𝕞𝕡𝕠𝕟𝕘𝕠 ♥ | ☆]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
module.exports = {
	config: {
		name: "help",
		version: "1.17",
